...
\draw[color=black,fill=cyan] (0,0) circle (1);
\draw[color=black] (-1,-1) -- (-1,1) -- (1,1) -- (1,-1) -- cycle;
\draw[red] plot[only marks, mark=*, mark size=0.5, domain=-1:1, samples=100] (\x,{rnd*2-1});
\draw[green] plot[only marks, mark=*, mark size=0.5, domain=-1:1, samples=100] (\x,{rnd*2-1});
\draw[yellow] plot[only marks, mark=*, mark size=0.5, domain=-1:1, samples=100] (\x,{rnd*2-1});
\draw[violet] plot[only marks, mark=*, mark size=0.5, domain=-1:1, samples=100] (\x,{rnd*2-1});
